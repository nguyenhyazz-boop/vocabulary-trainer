...
# Tạo 2 Tab: 1 Tab Tạo bài mới, 1 Tab Xem lịch sử
...
with tab_create:
    ...
    # 4. GỬI YÊU CẦU CHO GEMINI AI & LƯU LỊCH SỬ
    ...
    # Hiển thị bài đọc vừa tạo (Bài mới nhất trong Lịch sử)
    if ai_history:
        latest_item = ai_history[0]
        st.write("---")
        st.subheader("📄 Bài tập vừa tạo:")
...
with tab_history:
    ...
    if not ai_history:
        st.info("Chưa có lịch sử bài đọc nào. Hãy sang Tab **Tạo bài đọc mới** để tạo bài nhé!")
    else:
        # Nút xóa lịch sử
        ...
        # Duyệt qua từng bài đọc cũ trong lịch sử
